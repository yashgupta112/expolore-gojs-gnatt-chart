...
import './App.css';
import { DiagramWrapper } from './DiagranWrapper';
...
class GanttChart extends React.Component<any, AppState> {
  ...
  constructor(props: any) {
    ...
    // if (props.nodeDataArray) this.state.nodeDataArray = props.nodeDataArray);
